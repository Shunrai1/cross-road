...
export default class Resources extends EventEmitter {
  constructor(sources, options = {}) {
    ...
    this.options = {
      dracoDecoderPath: 'https://www.gstatic.com/draco/v1/decoders/', // Draco 模型压缩解码器路径
      ktx2TranscoderPath: 'https://unpkg.com/three/examples/jsm/libs/basis/', // KTX2 纹理转码器路径
      ...options, // 允许外部传入自定义选项覆盖默认值
    }
